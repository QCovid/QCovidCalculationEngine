...
namespace QCovid.RiskCalculator
{
    /// <summary>
    /// The version numbers for QCovid
    /// </summary>
    public static class VersionNumbers
    {
        /// <summary>
        /// The version of the QCovid algorithm
        /// </summary>
        public static readonly string CoreVersion = "1.3";
        ...
        static VersionNumbers()
        {
            ...
            WrapperVersion = fileVersionInfo.ProductVersion; // only the first three numbers
        }
    }
}
