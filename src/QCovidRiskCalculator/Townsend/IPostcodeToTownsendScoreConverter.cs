...
{
    /// <summary>
    /// Takes a postcode and returns an encrypted Townsend score instance
    /// based on the content of an encrypted database
    /// </summary>
    public interface IPostcodeToTownsendScoreConverter
    {
        /// <summary>
        /// Takes a postcode and returns an encrypted Townsend score instance
        /// based on the content of an encrypted database
        /// </summary>
        EncryptedTownsendScore GetTownsendScore(Postcode postcode);
    }
}
