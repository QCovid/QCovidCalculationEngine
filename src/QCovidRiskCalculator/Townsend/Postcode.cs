...
namespace QCovid.RiskCalculator.Townsend
{
    ...
    public class Postcode
    {
        ...
        /// <summary>
        /// The postcode, converted to all-caps with no white-space.
        /// </summary>
        public string PostcodeString { get; }

        /// <summary>
        /// 
        /// </summary>
        /// <param name="postcodeString"></param>
        public Postcode(string postcodeString)
        {
            PostcodeString = WhiteSpace.Replace(postcodeString.ToUpperInvariant(), "");
        }
    }
}
