...
{
    // <summary>
    // Constants used for checking Database versions.
    // Linked to QCovidTestHelpers as we can't reference the DLL.
    // </summary>
    internal static class MedicalCodeDbConstants
    {
        public const string MedicalCodesOutputVersion = "1.1";
        // See the name of the excel sheet in docs
        public const int MedicalCodesSpecVersion = 11;
        // See the VersionHistory table in the provided database
        public const int MedicalCodesSourceVersion = 7;

        public const string MedicalCodesVersionTable = "Versions";
        public const string MedicalCodesMainTable = "Codes";

        // ids are way above ethnicity ids to avoid any chance of a clash
        public const int ChemotherapyGroupAId = -101;
        public const int ChemotherapyGroupBId = -102;
        public const int ChemotherapyGroupCId = -103;
    }
}
