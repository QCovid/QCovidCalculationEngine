...
{
    // <summary>
    // When a code, e.g. a SNOMED code, appears in a patient's record, it will be represented
    // by one of these instances for the purposes of mapping it to the risk inputs
    // </summary>
    internal class CodeGroupInstance : MedicalCodeInstance
    {
        public int CodeGroupId { get; }

        public CodeGroupInstance(Date date, int codeGroupId, string code, CodeType codeType) : base(codeType, code, date)
        {
