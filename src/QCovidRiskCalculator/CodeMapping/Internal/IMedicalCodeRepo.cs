...
{
    internal interface IMedicalCodeRepo
    {
        // <summary>
        // Given a list of medical codes, returns a list of code groups or an error code
        // </summary>
        // <param name="medicalCodes"></param>
        // <returns></returns>
        MedicalCodeToCodeGroupMappingResult GetCodeGroupIdsFromMedicalCodes(IEnumerable<MedicalCodeInstance> medicalCodes);
    }
}