...
{
    internal class CodeGroupMapperResult
    {
        public RiskInput RiskInput { get; }
        public IReadOnlyList<CodeGroupInstance> RecognisedCodeGroupInstances { get; }

        public CodeGroupMapperResult(RiskInput riskInput, IReadOnlyList<CodeGroupInstance> recognisedCodeGroupInstances)
        {
            RiskInput = riskInput;
            RecognisedCodeGroupInstances = recognisedCodeGroupInstances;
        }
    }
}
