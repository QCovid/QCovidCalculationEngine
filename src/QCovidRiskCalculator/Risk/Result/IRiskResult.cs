...
namespace QCovid.RiskCalculator.Risk.Result
{
    ...
    public interface IRiskResult
    {
        ...
        /// </summary>
        IReadOnlyList<QCovidErrorCode> ErrorCodes { get; }
        ...
        /// </summary>
        RiskResultForSubjectType ResultForPatient { get; }

        /// <summary>
        /// Results for the a person with the same age and sex and the patient but without the risk factors
        /// </summary>
        RiskResultForSubjectType ResultForTypicalPersonSameAgeSex { get; }
    }
}