...
{
    /// <summary>
    /// A range of valid inputs of type <typeparamref name="T"/>
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public class ValidationRange<T> where T : IComparable<T>
    {
        /// <summary>
        /// The minimum (or earliest) acceptable value
        /// </summary>
        public T MinimumInclusive { get; }
        
        /// <summary>
        /// The maximum (or latest) acceptable value
        /// </summary>
        public T MaximumInclusive { get; }

        internal ValidationRange(T min, T max)
        {
