...
namespace QCovid.RiskCalculator.Exceptions.Internal
{
    // <summary>
    // Thrown when the constructor or analysis method of the mapping detects an issue, which will be due to developer error
    // </summary>
    internal class InvalidCodeGroupMappingException : Exception
    {
        public InvalidCodeGroupMappingException(string message) 
            : base(message)
        {
        }
    }
