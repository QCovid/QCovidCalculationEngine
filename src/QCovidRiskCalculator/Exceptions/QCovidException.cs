...
{
    /// <summary>
    /// An <see cref="Exception"/> thrown by QCovid
    /// </summary>
    public class QCovidException : Exception
    {
        /// <summary>
        /// A code corresponding to a <see cref="QCovidErrorCode"/>
        /// </summary>
        public int Code { get; }

        internal QCovidException(QCovidErrorCode errorCode) : base(errorCode.Message)
        {
            Code = errorCode.Code;
        }
    }
